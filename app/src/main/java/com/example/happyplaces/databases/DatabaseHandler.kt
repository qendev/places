...
class DatabaseHandler(context: Context):
    ...
    fun addHappyPlace(happyPlace: HappyPlaceModel): Long {
        ...
        contentValues.put(KEY_TITLE, happyPlace.name) // HappyPlaceModelClass TITLE
    ...
    /**
     * Function to updating a Happy Place details to SQLite Database.
     */
    ...
    fun deleteHappyPlace(happyPlace: HappyPlaceModel):Int{
        //create a writtable database
        val db = this.writableDatabase
        val successDelete = db.delete(TABLE_HAPPY_PLACE, KEY_ID + "=" +happyPlace.id,null)
        db.close()
